...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found:
    // - Expected Bob at position 1, but found Sue
    // - Enqueue method adds a person to the beginning of the queue rather than to the end of the queue
    ...
    // Defect(s) Found:
    // - Enqueue adds person to the beginning of the queue instead of the end
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:
    // - GetNextPerson has a constraint that it doesn't enqueue a person if they have < 1 turns
